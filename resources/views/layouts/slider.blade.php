        ...
        <ul>
          ...
          <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
            ...
            <div class="tp-caption tp-resizeme text-grey rs-parallaxlevel-0" 
              ...
              data-splitout="none" 
              data-responsive_offset="on" 
              style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Enjoy the 
              <span class="text-theme-colored">yumminess</span> of a true <span class="text-theme-color-2">Healthy Bread.</span>
            </div>
            <!-- LAYER NR. 4 -->
            <div class="tp-caption tp-resizeme text-grey rs-parallaxlevel-0" 
              id="slide-2-layer-4" 
              ...
              data-splitout="none" 
              data-responsive_offset="on" 
              style="z-index: 7; white-space: nowrap;">We provide bread made from Orange Fleshed Sweet Potato (OFSP) <br> 
                that comes with abundant vitamin in every bite.
            </div>
            <!-- LAYER NR. 5 -->
            <div class="tp-caption tp-resizeme text-grey rs-parallaxlevel-0" 
              id="slide-2-layer-5" 
          ...
          <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
            ...
            <div class="tp-caption tp-resizeme text-grey rs-parallaxlevel-0" 
              ...
              data-y="['top','top','top','top']" data-voffset="['90','100','70','90']" 
              data-fontsize="['56','46','40','36']"
              data-lineheight="['70','60','50','45']"
              data-fontweight="['800','700','700','700']"
              ...
              data-splitout="none" 
              data-responsive_offset="on" 
              style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">For the <span class="text-theme-colored">spicy</span> part of life, think Organic <span class="text-theme-color-2"> Spices.</span>
            </div>
            <!-- LAYER NR. 3 -->
            <div class="tp-caption tp-resizeme text-grey rs-parallaxlevel-0" 
              id="slide-3-layer-3" 
