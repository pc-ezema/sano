          ...
          <div class="col-md-5">
            <div class="widget pull-right flip sm-pull-none">
              <ul class="nav navbar-nav list-bordered language-switcher">
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="http://placehold.it/18x12" alt="En"> ENG <span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="#"><img src="http://placehold.it/18x12" alt="En"> France</a></li>
                    <li><a href="#"><img src="http://placehold.it/18x12" alt="En"> German</a></li>
                    <li><a href="#"><img src="http://placehold.it/18x12" alt="En"> Italy</a></li>
                  </ul>
                </li>
              </ul>
            </div>
        ...
        <div class="container">
          <nav id="menuzord" class="menuzord green">
            <ul class="menuzord-menu">
              ...
              <li class="active pull-right"><a href="#" class="font-20 line-height-1"><i class="pe-7s-call mr-10 font-28"></i> +(012) 345 6789</a></li>
            </ul>
          </nav>
        </div>
      </div>
