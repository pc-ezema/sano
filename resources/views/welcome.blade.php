                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="text-center mb-30 p-10">
                            ...
                            <p>Turmeric is a bright yellow-orange spice commonly used in curries and sauces. It comes from
                                the turmeric root. The spice has been used for its medicinal, antioxidant, and
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="text-center mb-30 p-10">
                            ...
                            <p>Thyme is an herb with dietary and medicinal uses. The flowers, leaves, and oil of thyme have
                                been used to treat a range of symptoms and complaints. These include diarrhea, stomach ache,
                                arthritis, and sore throat</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="text-center mb-30 p-10">
                            ...
                            <p>A bread made from orange fleshed sweet potato, with numerous health benefits, which is an
                                excellent source of Vitamin A. It is very effective in decreasing diabetic complications and
                                curing internal and external inflammations.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="text-center mb-30 p-10">
                            ...
                            <p> Organic chicken is a frozen chicken from broilers fed organically, without the use vaccines,
                                antibiotics and chemical growth hormones. They are free from toxins, improves immunity and
                                reduces chances of cancer.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="text-center mb-30 p-10">
                            ...
                            <p>Priscus Lemongrass tea has high Citral content which gives it more potency for
                                detoxification, reducing blood pressure and boosting metabolism which makes digestion
                                quicker and helps in burning more calories.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="text-center mb-sm-30 p-10">
                            ...
                            <p>SANO Smoked fish comes with a unique taste and flavour. it is a great source of anti-
                                inflammatory omega 3s and a great source of protein. Our smoked fish is packed with punch of
                                essential nutrients our bodies need to function .</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="section-content">
                                ...
                                <div class="effect-wrapper">
                                    ...
                                    <div class="info-box">
                                        ...
                                        <div class="info-content text-white bg-theme-colored-transparent-9">
                                            <h3 class="text-white mt-0"><i class="fa fa-globe font-24"></i>
                                                {{ $data->title }}
                                            </h3>
                ...
                <div>
                    <nav>
                        <ul class="pager dark">
                            <li class="previous"><a href="/our-products"> View More <span
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="gallery-isotope default-animation-effect grid-3 gutter-small clearfix"
                                    ...
                                    <div class="icons-holder">
                                        <div class="icons-holder-inner">
                                            <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                <a href="/images/sano-gallery/organic-chicken.jpg"
                            ...
                            <div class="gallery-item branding photography">
                                <div class="thumb">
                                    <img class="img-fullwidth" src="/images/sano-gallery/scent-leaves-powder.jpg"
                                        alt="project">
                                    <div class="img-gallery-text-holder">
                                    ...
                                    <div class="icons-holder">
                                        <div class="icons-holder-inner">
                                            <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                <a href="/images/sano-gallery/scent-leaves-powder.jpg"
                                                    data-lightbox-gallery="gallery" title="Your Title Here"><i
                                                        class="fa fa-picture-o"></i></a>
                                            </div>
                                        </div>
                            ...
                            <div class="gallery-item design">
                                <div class="thumb">
                                    <img class="img-fullwidth" src="/images/sano-gallery/sweet-basil-powder.jpg"
                                        alt="project">
                                    <div class="img-gallery-text-holder">
                                        <div class="img-gallery-text"></div>
                                    </div>
                                    ...
                                    <div class="icons-holder">
                                        <div class="icons-holder-inner">
                                            <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                <a href="/images/sano-gallery/sweet-basil-powder.jpg"
                                                    data-lightbox-gallery="gallery" title="Your Title Here"><i
                                                        class="fa fa-picture-o"></i></a>
                                            </div>
                                        </div>
                            ...
                            <div class="gallery-item branding">
                                <div class="thumb">
                                    ...
                                    <div class="icons-holder">
                                        <div class="icons-holder-inner">
                                            <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                <a href="/images/sano-gallery/thyme-leaves.jpg"
                                                    data-lightbox-gallery="gallery" title="Your Title Here"><i
                                                        class="fa fa-picture-o"></i></a>
                                            </div>
                                        </div>
                            ...
                            <div class="gallery-item design photography">
                                <div class="thumb">
                                    ...
                                    <div class="icons-holder">
                                        <div class="icons-holder-inner">
                                            <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                <a href="/images/sano-gallery/bread.jpg" data-lightbox-gallery="gallery"
                            ...
                            <div class="gallery-item photography">
                                <div class="thumb">
                                    ...
                                    <div class="icons-holder">
                                        <div class="icons-holder-inner">
                                            <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                <a href="/images/sano-gallery/cookies.jpg" data-lightbox-gallery="gallery"
                                                    title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item branding">
                                <div class="thumb">
                                    <img class="img-fullwidth" src="/images/sano-gallery/sano-thyme-leaves.jpg"
                                        alt="project">
                                    <div class="img-gallery-text-holder">
                                        <div class="img-gallery-text"></div>
                                    </div>
                                    ...
                                    <div class="icons-holder">
                                        <div class="icons-holder-inner">
                                            <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                <a href="/images/sano-gallery/sano-thyme-leaves.jpg"
                                                    data-lightbox-gallery="gallery" title="Your Title Here"><i
                                                        class="fa fa-picture-o"></i></a>
                                            </div>
                                        </div>
                            ...
                            <div class="gallery-item photography">
                                <div class="thumb">
                                    ...
                                    <div class="icons-holder">
                                        <div class="icons-holder-inner">
                                            <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                <a href="/images/sano-gallery/cupcake.jpg" data-lightbox-gallery="gallery"
                                                    title="Your Title Here"><i class="fa fa-picture-o"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item branding">
                                <div class="thumb">
                                    ...
                                    <div class="icons-holder">
                                        <div class="icons-holder-inner">
                                            <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                <a href="/images/sano-gallery/curry-powder.jpg"
                                                    data-lightbox-gallery="gallery" title="Your Title Here"><i
                                                        class="fa fa-picture-o"></i></a>
                                            </div>
                                        </div>
